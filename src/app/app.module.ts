...
import { SelectBgComponent } from './components/select-bg/select-bg.component';
...
import { SelectBgBlueComponent } from './components/select-bg-blue/select-bg-blue.component';
