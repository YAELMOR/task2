...
@Component({
  selector: 'app-select-bg-blue',
  templateUrl: './select-bg-blue.component.html',
  styleUrls: ['./select-bg-blue.component.css']
})

export class SelectBgBlueComponent implements OnInit {
    selected: string;
    title: string;
    ImagePath: string;
